...
Communities are a lot like solar systems. In a solar system, planets and
celestial bodies of all shapes and sizes orbit around a central mass, coming and
going at various distances and frequencies. Members in a community act the same
way. Some orbit close to the center and pass by frequently. Others stay a little
further out, and we only see them occasionally.
...
_Illustration idea: a member climbing a set of steps:_
...
planning growth, since its best to add new, low-love members only when we have enough
...
_Illustration idea: orbit levels in the gravitational cone:_
...
_Illustration idea: the ice cream cone, showing how community sprinkles the
goodness down onto the business goals_

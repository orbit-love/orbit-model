...
To ge there, let's take the gravity calculation one step at a time, starting with each
individual member. 
...
members move along, their [orbit level](/orbit-levels) changes. 
...
_Illustration: commitment curve with orbit levels page, should add 12 tick marks on y-axis_
...
Okay, now we know how our members have moved through the different levels, but in reality, all levels aren't created equal. Getting an explorer to participate is great, but getting a member to step up and become a leader is both valuable and difficult. It requires *much* more commitment. 
...
There are two levers for increasing the gravity of ao community: love and reach. Tactically, this looks like providing more relevant opportunities for members to get invovled, and creating more opportunities for members to connect with one another.  

...
export default function Slide5(props) {
  ...
  return (
    <Slide image={slideFiveImage} altText={altText} {...props}>
      ...
      <br></br>
      <div className="xs:text-3xl px-4 text-xl font-extrabold tracking-wide md:px-0 md:w-5/6 md:text-5xl">
        Organize with orbit levels
      </div>
      <div className="xs:text-lg px-4 w-full tracking-wide leading-relaxed md:px-0 md:w-4/5 md:text-xl">
        <div>
          Every community member deserves the right experience. Design programs
          that engage members appropriately according to their orbit level,
          based on their love.
        </div>
        <br></br>
        <div>
